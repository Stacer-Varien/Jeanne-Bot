...
os.system(
    "pip install -U discord requests python-dotenv humanfriendly datetime pillow py-expression-eval topggpy lxml reactionmenu git+https://github.com/Gorialis/jishaku@master"
)
