...
class moderation():
    ...
    async def commit_ban(
        ...
        ban.add_field(name="ID du dossier", value=f"`#{case_id}`", inline=True)
    ...
    async def warn(
        ...
        warn.add_field(name="ID du dossier", value=f"`#{case_id}`", inline=True)
    ...
    async def clearwarn(self, ctx: Interaction, member: Member, warn_id: int):
        ...
        case_id = await mod.create_case(
            ...
            member,
            ctx.user,
            f"Avertissement ID {warn_id} révoqué",
        ...
        revoked_warn.add_field(name="ID du dossier", value=f"`#{case_id}`", inline=True)
        modlog = Moderation(ctx.guild).get_modlog_channel
        if modlog is None:
    ...
    async def kick(
        ...
        kick.add_field(name="ID du dossier", value=f"`#{case_id}`", inline=True)
    ...
    async def unban(
        ...
        unban.add_field(name="ID du dossier", value=f"`#{case_id}`", inline=True)
    ...
    async def timeout(
        ...
        mute.add_field(name="Durée", value=duration, inline=True)
        mute.add_field(name="Raison", value=reason, inline=False)
        mute.add_field(name="ID du dossier", value=f"`#{case_id}`", inline=True)
    ...
    async def timeoutremove(
        ...
        unmute.add_field(name="ID du dossier", value=f"`#{case_id}`", inline=True)
