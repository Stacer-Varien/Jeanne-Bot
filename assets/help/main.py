...
class help_menu(ui.Select):
    ...
    async def callback(self, ctx: Interaction):
        ...
        if self.values[0] == "Fun":
            ...
            embed.add_field(
                name="8 Ball", value="Ask 8 ball anything and you will get your answer\nExample: `/8ball [QUESTION]`", inline=False)
            embed.add_field(
                name="Combine", value="Type two words to get one combined word\nExample: `/combine [WORD_1] [WORD_2]`", inline=False)
            embed.add_field(
                name="Choose", value="Add some choices and I will choose for you. Split them with ','\nExample: `/choose [CHOICES]`", inline=False)
            embed.add_field(
                name="Reverse", value="Say something and I will say it in reversed text\nExample: `/reverse [TEXT]`", inline=False)
            embed.add_field(
                name="Animeme", value="Get a random animeme\nExample: `/animeme`", inline=False)
            embed.add_field(
                name="Gay Rate", value="Check how gay you or the member is\nExample: `/gayrate {member}`", inline=False)
            embed.add_field(
                name="Simp Rate", value="Check how much of a simp you or the member is\nExample: `/simprate {member}`", inline=False)
            ...
            embed.add_field(
                name="Daily", value="Claim your daily. On weekends, you can claim twice the ammount\nExample: `/daily`", inline=False)
            embed.add_field(
                name="Guess", value="Guess my number and you can win QP. \nExample: `/guess free` then after she asks, `NUMBER`\n`/guess bet [AMOUNT]` then after she asks, `[NUMBER]`", inline=False)
            embed.add_field(
                name="Choose", value="Add some choices and I will choose for you. Split them with ','\nExample: `/choose [CHOICES]`", inline=False)
            embed.add_field(
                name="Reverse", value="Say something and I will say it in reversed text\nExample: `/reverse [TEXT]`", inline=False)
