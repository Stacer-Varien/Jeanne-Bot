...
class Hentai:
    ...
    def get_cached_hentai(self, source: str, tags: Optional[str] = None)-> (list | tuple[str, str] | None):
        images = []
        data = db.execute(
        ...
        return str(choice(images if (len(images) > 0) else data)[1]), str(images[3])
